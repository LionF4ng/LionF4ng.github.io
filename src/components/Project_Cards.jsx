...
function Project_Cards({image_name}){
    ...
    {/*If flex is present the project has a demo, otherwise hidden is present*/}
    let has_demo
    ...
    switch (image_name) {
        case "Logos":
            ...
            youtube_link = ""
            has_demo = "hidden w-fit ml-5 my-auto mb-5 content-end"
            card_class = "flex flex-col mx-2 w-155 xl:h-180 rounded-3xl border-4 my-4 bg-red-950 border-red-600"
            break;
        case "Salify":
        ...
        case "Learn-To-Sing":
            ...
            has_demo = "flex w-fit ml-5 my-auto mb-5 content-end"
            card_class = "flex flex-col mx-2 w-155 xl:h-180 rounded-3xl border-4 my-4 bg-red-950 border-red-600"
            break;
        case "Alpha-Spike":
    ...
    return(
    <div key={image_name} class={card_class}>
        ...
        whileTap={{ scale: 0.95}}
        transition={easeInOut} href= {youtube_link} target="_blank" class={has_demo}>
